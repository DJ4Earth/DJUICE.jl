...
### Option 1: Let Pluto.jl to handle the package

You can simply use `using DJUICE`  and let `Pluto.jl` to handle the package. For the first time, this may take a few minutes.
...
git-tree-sha1 = "2a5af7529811e9e10600a9d20d10485b72996412"
